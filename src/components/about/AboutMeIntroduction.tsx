        ...
        <div className="md:w-3/5">
          ...
          <div className="space-y-4 text-lg">
            ...
            <p className="">
              ...
              with
              <span className="inline-flex items-center ml-1">
                <FaRegClock className="text-primary mx-1" />
            ...
            <div className="pt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                <div className="flex flex-col items-center p-4 bg-gray-800/40 rounded-lg hover:bg-gray-700/40 transition-colors duration-300">
                  <GiBookCover className="text-4xl text-primary mb-2" />
                  <span>Documentaries</span>
                </div>

                <div className="flex flex-col items-center p-4 bg-gray-800/40 rounded-lg hover:bg-gray-700/40 transition-colors duration-300">
                  <GiCook className="text-4xl text-primary mb-2" />
                  <span>Cooking</span>
                </div>

                <div className="flex flex-col items-center p-4 bg-gray-800/40 rounded-lg hover:bg-gray-700/40 transition-colors duration-300">
                  <GiHiking className="text-4xl text-primary mb-2" />
                  <span>Hiking</span>
                </div>
              </div>
            </div>
